...
t.create('GitHub Total Discussions (repo not found)')
  ...
  .expectBadge({ label: 'discussions', message: 'repo not found', namedLogo: 'githubdiscussion' })
...
t.create('GitHub Total Discussions (repo having discussions)')
  ...
  .expectBadge({ label: 'discussions', message: numberSpaceTotal, namedLogo: 'githubdiscussion' })
